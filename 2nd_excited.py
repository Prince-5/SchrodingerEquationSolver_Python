...
E = 0.20 # Trial Eigen value (This trial value should be slightly greater than the Eigen value of the previous state for accurate result.)
...
def wavefunction(E,k2,N):
    ...
    Psi[1] = 0.013328 # These two values should already be given for the normalised wave function.
...
plt.xlabel('x') 
plt.ylabel('Psi(x)') 
plt.title('2nd excited state , E3 = '+ str(E))

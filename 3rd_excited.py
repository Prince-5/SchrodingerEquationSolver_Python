...
E = 0.45 # Trial Eigen value (This trial value should be slightly greater than the Eigen value of the previous state for accurate result.)
...
def wavefunction(E,k2,N):
    ...
    Psi[1] = 0.017771 # These two values should already be given for the normalised wave function.
...
plt.xlabel('x') 
plt.ylabel('Psi(x)') 
plt.title('3rd excited state , E4 = '+ str(E))
